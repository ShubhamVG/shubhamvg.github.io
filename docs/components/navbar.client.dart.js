...
B.v=new A.d0()
B.z=new A.dp(null)
B.J=new A.E("Projects","/projects","project")
B.F=new A.E("Blogs","/blogs","blogs")
B.D=new A.E("Goals","/goals","goals")
B.I=new A.E("Support","/support","supports")
B.E=new A.E("Contacts & Socials","/contacts","contacts")
B.H=new A.E("Fav Tech","/fav-tech","favTech")
B.G=new A.E("Journey","/journey","journey")
B.C=new A.E("Skills & Hobbies","/skills-hobbies","skillsHobbies")
B.A=A.k(s([B.J,B.F,B.D,B.I,B.E,B.H,B.G,B.C]),A.ep("w<E>"))
B.K={svg:0,math:1}
