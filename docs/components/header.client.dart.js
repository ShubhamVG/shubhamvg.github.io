...
B.Q=new A.H("Goals","/goals/","goals")
B.W=new A.H("Support","/support/","supports")
B.S=new A.H("Contacts & Socials","/contacts/","contacts")
B.T=new A.H("Fav Tech","/fav-tech/","favTech")
B.R=new A.H("Journey","/journey/","journey")
B.U=new A.H("Skills & Hobbies","/skills-hobbies/","skillsHobbies")
B.M=A.j(s([B.V,B.P,B.Q,B.W,B.S,B.T,B.R,B.U]),A.cC("x<H>"))
